...
| Items `fidelity_score = null` non re-vérifiés | Moyenne | Élevé | Job quotidien de re-vérification fidelity (AC Z3-AC10). Item restreint aux templates simples après 3 jours de timeout persistant. Empêche les hallucinations LLM de rester indéfiniment en usage sans vérification. |
