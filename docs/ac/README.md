...
> | | |
> |---|---|
> | **Périmètre** | 8 zones critiques · 162 AC en format Given/When/Then |
...
| Z2 | Pipeline J0 — Error paths & timeouts | Très élevé | 15 | [Z2.md](Z2.md) |
| Z3 | Validation HITL — Skip / Ignore / Qualité items | Élevé | 17 | [Z3.md](Z3.md) |
| Z4 | Lazy generation — Concurrence, cache & session experience | Élevé | 16 | [Z4.md](Z4.md) |
| Z5 | ChapterRevision — Identité Item & héritage | Élevé | 10 | [Z5.md](Z5.md) |
| Z6 | Emploi du temps, Notifications, Engagement & Confiance parent | Élevé | 43 | [Z6.md](Z6.md) |
| Z7 | Routine de soirée & Orchestration | Très élevé | 25 | [Z7.md](Z7.md) |
...
> **53 ACs retenus sur 162 (33%)** — Version locale pour un binôme père-fils, validant la boucle pédagogique fondamentale sur les 4 packs pilotes.
