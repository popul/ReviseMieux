...
> | | |
> |---|---|
> | **Périmètre** | 8 zones critiques · 166 AC en format Given/When/Then |
...
> **53 ACs retenus sur 166 (32%)** — Version locale pour un binôme père-fils, validant la boucle pédagogique fondamentale sur les 4 packs pilotes.
